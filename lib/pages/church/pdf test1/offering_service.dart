...
class PdfInvoiceService {
  ...
  Future<Uint8List> createInvoice(List<Product> soldProducts) async {
    ...
    // final image = (await rootBundle.load("profile-default.jpeg"))
    //     .buffer
    //     .asUint8List();

    // final font = await rootBundle.load('OpenSans-Regular.ttf');
    // // await rootbundle.load("assets/open-sans.ttf");
            ...
            children: [
              ...
              pw.Row(
                ...
                children: [
                  pw.Column(
                    children: [
                      pw.Text("Customer Name", style: TextStyle(font: ttf)),
                  ...
                  pw.Column(
                    children: [
                      ...
                      pw.Text("Weird Street Name 1", style: TextStyle(font: ttf)),
